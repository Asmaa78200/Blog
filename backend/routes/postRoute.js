...
const { creatPost, showPost, showSinglePost, deletePost, updatePost, addComment, addLike, removeLike } = require("../controllers/postcontroller");
const {isAuthenticated, isAdmin}= require('../middleware/auth');

//blog routes
router.post('/post/create',isAuthenticated, isAdmin, creatPost);
